...
from iou3d_nms.iou3d_nms_utils import boxes_iou3d_gpu
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_root_dir', type=str, default='./results_all', help='output folder')
    parser.add_argument('--data_dir', type=str, default = '/workspace/data/tracking/train_datasets/KITTI_Tracking/truly_using/',  help='dataset path')
    parser.add_argument('--model', type=str, default = 'vote_netR_36.pth', help='model name for training resume')
    parser.add_argument('--category_name', type=str, default = 'All', help='Object to Track (Car/Pedestrian/Van/Cyclist)')
    ...
    model_dir = './results_all/'#/results/
    for file in sorted(os.listdir(model_dir)):
        if file.find('optimizer')!=-1: continue
        args.manualSeed = 1
        ...
        if file.endswith('.pth'):
            ...
            if int(suffix.split('.')[0])<10: continue
            print('\n', file)
        ...
        logging.info("mean Succ/Prec {}/{}".format(Succ, Prec))
